...
from stable_baselines3.common.distributions import (
    ...
    SoftmaxCategoricalDistribution,
...
class OffCAPOMlpPolicy(BasePolicy):
    """
    ...
    def __init__(
        ...
        super(OffCAPOMlpPolicy, self).__init__(
            observation_space,
            action_space,
        ...
        # overwrite distribution to use SoftmaxCategoricalDistribution 
        if type(self.action_dist) == CategoricalDistribution:
            self.action_dist = SoftmaxCategoricalDistribution(action_space.n)
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        elif isinstance(self.action_dist, (CategoricalDistribution, MultiCategoricalDistribution, BernoulliDistribution, SoftmaxCategoricalDistribution)):
    ...
    def forward(self, obs: th.Tensor, actions: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor) -> Distribution:
        ...
        elif isinstance(self.action_dist, SoftmaxCategoricalDistribution):
            return self.action_dist.proba_distribution(action_logits=mean_actions)
...
class OffCAPOCnnPolicy(OffCAPOMlpPolicy):
    """
    ...
    def __init__(
        ...
        super(OffCAPOCnnPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
...
class MultiInputOffCAPOMlpPolicy(OffCAPOMlpPolicy):
    """
    ...
    def __init__(
        ...
        super(MultiInputOffCAPOMlpPolicy, self).__init__(
            observation_space,
            action_space,
            lr_schedule,
            net_arch,
...
MlpPolicy = OffCAPOMlpPolicy
CnnPolicy = OffCAPOCnnPolicy
# MultiInputPolicy = MultiInputOffCAPOMlpPolicy

register_policy("MlpPolicy", OffCAPOMlpPolicy)
register_policy("CnnPolicy", OffCAPOCnnPolicy)
