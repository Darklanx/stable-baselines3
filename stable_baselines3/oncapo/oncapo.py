...
class OnCAPO(OnPolicyAlgorithm):
    ...
    def __init__(
        self,
        policy: Union[str, Type[OnCAPOMlpPolicy]],
        ...
        super(OnCAPO, self).__init__(
            policy,
            env,
            learning_rate=learning_rate,
            policy_base=OnCAPOMlpPolicy,
            n_steps=n_steps,
            gamma=gamma,
    ...
    def learn(
        ...
        tb_log_name: str = "OnCAPO",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "OnCAPO":
        print("Eval_freq that should output -1 regardless of true eval_freq (oncapo.py learn()):  ", eval_freq)
        return super(OnCAPO, self).learn(
